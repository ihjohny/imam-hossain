...
class CodegenLoader extends AssetLoader{
  ...
  "experienceData": [
    {
      ...
      "responsibilities": [
        ...
        "Engineered high-performance TelCo app (MyGP) for heavy traffic.",
        "Redesigned app architecture for 30M+ users, reducing server load.",
        "Streamlined telecom purchase/payment modules, boosting revenue.",
        "Added live GPS tracking and printer SDKs to delivery apps.",
        "Mentored interns and juniors, sharing technical expertise.",
        "Skilled in Android (Kotlin), Flutter, and iOS (Swift).",
        "Collaborated across teams for timely, quality releases.",
        "Integrated third-party services and analytics tools."
      ],
      "tags": [
        {
          "type": "jetpack_compose",
          "title": "Jetpack Compose",
          "logo": {
            "assetName": "assets/images/jetpack_compose_logo.jpg"
          }
        },
        {
          "type": "kotlin",
          "title": "Kotlin",
          "logo": {
            "assetName": "assets/images/kotlin_logo.jpg"
          }
        },
        {
          "type": "dart",
          "title": "Dart",
          "logo": {
            "assetName": "assets/images/dart_logo.jpg"
          }
        }
      ]
    }
  ...
  "projectsData": [
    {
      "name": "MyGP - Offer, Recharge, Sports",
      "projectUrl": "https://play.google.com/store/apps/details?id=com.portonics.mygp",
      "cover": {
        "assetName": "assets/images/project-mygp.jpg"
      },
      "descriptionData": "MyGP is Grameenphone's all-in-one self-service telecommunications app with 50 million downloads on Play Store.",
    ...
    {
      "name": "Longshot",
      "projectUrl": "https://www.longshotcameras.com/pages/longshotapp",
      "cover": {
        "assetName": "assets/images/project-longshot.jpg"
      },
      "descriptionData": "Longshot app connects to Longshot cameras, providing live target viewing and tracking tools for precise shooting analysis.",
      "responsibilityData": "Implemented core features, including support for new camera models and camera detection through IP-based ping. Added a grid overlay option on the video feed to enhance precision in target tracking and analysis.",
      "technologyData": "Flutter, Bloc Architecture, Fijkplayer, Video Player, Screen Recording, Geolocator, Camera, etc.",
      "tags": [
        {
          "type": "flutter",
          "title": "Flutter",
    ...
    {
      "name": "My Robi: Offers, Usage & More!",
      "projectUrl": "https://play.google.com/store/apps/details?id=net.omobio.robisc",
      "cover": {
        "assetName": "assets/images/project-myrobi.jpg"
      },
      "descriptionData": "My Robi is a one-stop self-service app for telecommunications with 10 million downloads on Play Store.",
    ...
    },
    {
      ...
      "cover": {
        "assetName": "assets/images/project-hungrynaki.jpg"
      },
      "descriptionData": "HungryNaki is an online food ordering and delivery service launched in 2013 to deliver to doorsteps.",
      "responsibilityData": "Improved app performance with caching and API load optimization. Developed modules for Customers, Riders, and Partners. Implemented live GPS order tracking and integrated a printer SDK for handheld POS devices.",
      "technologyData": "Android SDK, Kotlin, MVVM Architecture, Dagger 2, RxJava 3, Coroutines, Apollo Android GraphQL, Android Jetpack Components, Data Binding, Navigation Component, Google Maps SDK, Aliyun OSS SDK, Android Service, etc.",
      "tags": [
        {
          "type": "android",
          "title": "Android",
